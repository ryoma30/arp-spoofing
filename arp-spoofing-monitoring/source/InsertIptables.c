#include "../header/InsertIptables.h"

int insertIptables(char *ip_address, unsigned char *mac_address)
{
        struct xtc_handle *h;
        ...
        e->ip.src.s_addr = inet_addr(ip_address);
        ...
        memcpy(macinfo->srcaddr, mac_address, 6);
        // macinfo->srcaddr[0] = 0;
        // macinfo->srcaddr[1] = 0;
        // macinfo->srcaddr[2] = 0;
        // macinfo->srcaddr[3] = 0;
